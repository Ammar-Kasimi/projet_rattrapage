...
<div class="container px-4 py-8 mx-auto max-w-4xl">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Modifier l'Événement : {{ $event->title }}</h1>
    ...
    <form action="{{ route('events.update', $event) }}" method="POST" id="editEventForm" enctype="multipart/form-data" class="p-8 bg-white rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ $event->title }}" required class="w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500">
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="location" value="{{ $event->address->location ?? '' }}" required class="w-full px-4 py-2 border rounded-lg focus:ring-green-500 focus:border-green-500">
            </div>
